    ...
    return (
        <div className="flex flex-col bg-zinc-300 rounded-2xl text-black overflow-hidden">
            <div className="flex justify-between items-center bg-white p-4">
               ...
               <IconReload size={24} className="cursor-pointer" 
            ...
            {mensagens.length === 0 ? (
                ...
                <div className="flex flex-col p-2 gap-2 min-h-[400px] sm:min-h-[500px] sm:max-h-[500px] max-h-[400px] overflow-y-scroll">
                    {mensagens.map((mensagens, i) => {
                        return <BalaoMensagem key={mensagens.id} mensagem={mensagens} />
                    })}
                    {pensando && (
